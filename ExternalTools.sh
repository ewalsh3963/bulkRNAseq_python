...
# export PATH="$TOOLS_DIR/$SRATOOLKIT_DIR/bin:$TOOLS_DIR/FastQC:$TOOLS_DIR:$TOOLS_DIR/STAR-2.7.10a/bin/Linux_x86_64_static:$PATH"

# echo "Verifying tool availability..."

# for tool in fastq-dump fastqc fastp htseq-count STAR; do
...
# echo "Setup complete. Remember to add the following line to your ~/.bashrc or ~/.zshrc to keep the PATH after reboot:"
# echo "export PATH=\"$TOOLS_DIR/$SRATOOLKIT_DIR/bin:$TOOLS_DIR/FastQC:$TOOLS_DIR:$TOOLS_DIR/STAR-2.7.10a/bin/Linux_x86_64_static:\$PATH\""
